...
module.exports = class Ng_Block {
    ...
    save() {
      return db.execute('INSERT INTO ng_block (no_empleado, turno_ng_block, descripcion_ng_block, fecha_uso_ng_block, fecha_solicitud_ng_block, estatus_ng_block) VALUES (?, ?, ?, ?, ?, ?)',
          [this.no_empleado, this.turno_ng_block, this.descripcion_ng_block, this.fecha_uso_ng_block, this.fecha_solicitud_ng_block, this.estatus_ng_block]);
    }
